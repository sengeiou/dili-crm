...
import com.dili.dp.domain.dto.*;
import com.dili.dp.provider.DataDictionaryValueProvider;
...
//		
     ...
     * @param weightType   权重类型(交易量 10 交易额 20 商品 30 支付方式:40)
     * @return 返回可用的条件
     */
