...
import com.dili.dp.constant.DpConstants;
import com.dili.dp.dao.PointsRuleMapper;
import com.dili.dp.domain.PointsRule;
import com.dili.dp.domain.PointsRuleLog;
import com.dili.dp.domain.RuleCondition;
import com.dili.dp.domain.dto.PointsRuleDTO;
import com.dili.dp.service.DataDictionaryValueRpcService;
import com.dili.dp.service.PointsRuleLogService;
import com.dili.dp.service.PointsRuleService;
...
public class PointsRuleServiceImpl extends BaseServiceImpl<PointsRule, Long> implements PointsRuleService {
    ...
    private void makeRuleCondition(PointsRule pointsRule, String numberJson, String moneyJson, String payMethodJson) {
        ...
        makeRuleCondition(pointsRule, numberRuleConditions, DpConstants.WeightType.NUMBER.getCode());

        List<RuleCondition> moneyRuleConditions = JSON.parseArray(moneyJson, RuleCondition.class);

        makeRuleCondition(pointsRule, moneyRuleConditions, DpConstants.WeightType.MONEY.getCode());

        List<RuleCondition> payRuleConditions = JSON.parseArray(payMethodJson, RuleCondition.class);

        makeRuleCondition(pointsRule, payRuleConditions, DpConstants.WeightType.PAYMETHOD.getCode());
    }
