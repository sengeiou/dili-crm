    ...
    <table style="padding:0px;width:100%;">
        ...
        <tr>
            <td width="50%" style="padding: 0px; margin: 0px;" valign="top">
                ...
                <div class="easyui-panel" id="salesReportDiv" data-options="collapsible:true,collapsed:true,onBeforeExpand:loadSalePortrait" header="#salesReportHeader">
            ...
            <td width="50%" style="padding: 0px; margin: 0px;" valign="top">
                ...
                <div class="easyui-panel" id="purchaseReportDiv" data-options="collapsible:true,collapsed:true,onBeforeExpand:loadPurchasePortrait" header="#purchaseReportHeader">
        ...
        <tr>
            <td style="padding: 0px; margin: 0px;" valign="top">
                ...
                <div class="easyui-panel" id="contributionReportDiv" data-options="collapsible:true,collapsed:true,onBeforeExpand:loadContributionPortrait" header="#contributionReportHeader">
