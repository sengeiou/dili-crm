 ...
 */
@Component
public class ProfessionProvider implements ValueProvider {
    private static final List<ValuePair<?>> buffer;

    static {
        buffer = new ArrayList<ValuePair<?>>();
        buffer.add(new ValuePairImpl("水果批发", "fruitsWholesale"));
        buffer.add(new ValuePairImpl("蔬菜批发", "vegetablesWholesale"));
        buffer.add(new ValuePairImpl("超市", "supermarket"));
    }
